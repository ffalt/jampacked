...
export type SearchAlbumsResultQuery = { albums: { total: number, skip?: number | null, items: Array<{ id: string, name: string, artist: { name: string } }> } };
...
export const SearchTracksResultDocument = gql`
  ...
  tracks(page: {take: $take, skip: $skip}, filter: {query: $query}) {
    ...
    `;
export type SearchTracksResultQueryResult = Apollo.QueryResult<SearchTracksResultQuery, SearchTracksResultQueryVariables>;
export const SearchSeriesResultDocument = gql`
  ...
  serieses(page: {take: $take, skip: $skip}, filter: {query: $query}) {
    ...
    `;
export type SearchSeriesResultQueryResult = Apollo.QueryResult<SearchSeriesResultQuery, SearchSeriesResultQueryVariables>;
export const SearchPodcastsResultDocument = gql`
  ...
  podcasts(page: {take: $take, skip: $skip}, filter: {query: $query}) {
    ...
    `;
export type SearchPodcastsResultQueryResult = Apollo.QueryResult<SearchPodcastsResultQuery, SearchPodcastsResultQueryVariables>;
export const SearchPlaylistsResultDocument = gql`
  ...
  playlists(page: {take: $take, skip: $skip}, filter: {query: $query}) {
    ...
    `;
export type SearchPlaylistsResultQueryResult = Apollo.QueryResult<SearchPlaylistsResultQuery, SearchPlaylistsResultQueryVariables>;
export const SearchFoldersResultDocument = gql`
  ...
  folders(page: {take: $take, skip: $skip}, filter: {query: $query}) {
    ...
    `;
export type SearchFoldersResultQueryResult = Apollo.QueryResult<SearchFoldersResultQuery, SearchFoldersResultQueryVariables>;
export const SearchEpisodesResultDocument = gql`
  ...
  episodes(page: {take: $take, skip: $skip}, filter: {query: $query}) {
    ...
    `;
export type SearchEpisodesResultQueryResult = Apollo.QueryResult<SearchEpisodesResultQuery, SearchEpisodesResultQueryVariables>;
export const SearchArtistsResultDocument = gql`
  ...
  artists(page: {take: $take, skip: $skip}, filter: {query: $query}) {
    ...
    `;
export type SearchArtistsResultQueryResult = Apollo.QueryResult<SearchArtistsResultQuery, SearchArtistsResultQueryVariables>;
export const SearchAlbumsResultDocument = gql`
  ...
  albums(page: {take: $take, skip: $skip}, filter: {query: $query}) {
    ...
    `;
export type SearchAlbumsResultQueryResult = Apollo.QueryResult<SearchAlbumsResultQuery, SearchAlbumsResultQueryVariables>;