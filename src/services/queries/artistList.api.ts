...
export type ArtistListResultQueryVariables = Exact<{
...
export interface ArtistListResultQuery {
	artists: {
		total: number;
		skip: number | null;
		take: number | null;
...
export const ArtistListResultDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'ArtistListResult' },
			variableDefinitions: [
				{
	...
	ArtistListResultQuery,
	ArtistListResultQueryVariables
>;
