...
export type SeriesListResultQuery = { serieses: { total: number, skip?: number | null, take?: number | null, items: Array<{ id: string, name: string, albumsCount: number }> } };
...
export const SeriesListResultDocument = gql`
  ...
  serieses(
    ...
    `;
export type SeriesListResultQueryResult = Apollo.QueryResult<SeriesListResultQuery, SeriesListResultQueryVariables>;