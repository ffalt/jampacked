...
export type ArtistResultQueryVariables = Exact<{
	id: string | number;
}>;
...
export const ArtistResultDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'ArtistResult' },
			variableDefinitions: [
				{
				...
				selections: [
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{ kind: 'Field', name: { kind: 'Name', value: 'albumsCount' } },
...
} as unknown as DocumentNode<ArtistResultQuery, ArtistResultQueryVariables>;
