...
export interface TrackResultQuery {
	track: {
		id: string;
		name: string;
...
export const TrackResultDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'TrackResult' },
			variableDefinitions: [
				{
								...
								},
								{
									...
									selectionSet: {
										...
										selections: [
											...
											{ kind: 'Field', name: { kind: 'Name', value: 'disc' } },
											{
												kind: 'Field',
...
} as unknown as DocumentNode<TrackResultQuery, TrackResultQueryVariables>;
