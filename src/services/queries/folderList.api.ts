...
export type FolderListResultQuery = { folders: { total: number, skip?: number | null, take?: number | null, items: Array<{ id: string, name: string, folderType: Types.FolderType, tracksCount: number, childrenCount: number }> } };
...
export const FolderListResultDocument = gql`
  ...
  folders(
    ...
    `;
export type FolderListResultQueryResult = Apollo.QueryResult<FolderListResultQuery, FolderListResultQueryVariables>;