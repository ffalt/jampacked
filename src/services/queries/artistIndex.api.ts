...
export type ArtistIndexResultQuery = { artistIndex: { groups: Array<{ name: string, items: Array<{ id: string, name: string, albumsCount: number }> }> } };
...
export const ArtistIndexResultDocument = gql`
  ...
  artistIndex(filter: {albumTypes: $albumTypes}) {
    ...
    `;
export type ArtistIndexResultQueryResult = Apollo.QueryResult<ArtistIndexResultQuery, ArtistIndexResultQueryVariables>;